...
## 2.3 模块设计 
该软件采用模块化设计，同时实现对学生和教师的信息管理，方便不同老师的使用。同
时由于学生对于不同学科有不同的学习情况，该软件方便对学生不同学科的管理。在抽取中
采用加权抽取，以便于对不同程度的学生抽取时都有所照顾。
# 第三章 详细设计
作品制作重点：
...
用，从而进行学号播报。
## 3.1 界面设计 
该软件在界面设计上共分为首页信息、学生管理、课堂考勤、课堂抽问、随机抽取、设
置管理六大模块(其中课堂考勤和课堂抽问使用了加权随机抽取算法)。
